...
class MockTurtleFactory : public TurtleFactory {
 public:
  Turtle* MakeTurtle(int length, int width) override { ... }
  Turtle* MakeTurtle(int length, int width, int speed) override { ... }
...
...
  MOCK_METHOD(bool, Foo,
              (bool visible, const string& name, int x, int y,
               (const map<pair<int, int>>), double& width, double min_weight,
               double max_wight));
...
...
bool MyIsVisibleInQuadrant1(bool visible, const string& name, int x, int y,
                            const map<pair<int, int>, double>& width,
